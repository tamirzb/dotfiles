...
require("config.utils").apply_highlights({
    ...
    DiagnosticUnderlineInfo = { underline = true, sp = colors.paleblue },
    ...
    LspReferenceText = { fg = colors.title, underline = true },
    LspReferenceRead = { fg = colors.title, underline = true },
    LspReferenceWrite = { fg = colors.title, underline = true },
})
